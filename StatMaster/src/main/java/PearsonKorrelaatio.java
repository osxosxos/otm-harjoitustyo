...
public class PearsonKorrelaatio {
    ...
    /**
     * Muuttujien välillä joko on tai ei ole tilastollisesti merkitsevä yhteys.
     */
    public void tulkinta() {
        if (this.pArvo.equals("ns")) {
            this.tulkinta = "Muuttujien välillä ei ole tilastollisesti merkittävää yhteyttä";
        } else {
            this.tulkinta = "Muuttujien välillä on tilastollisesti merkitsevä yhteys.";
        }
    }
