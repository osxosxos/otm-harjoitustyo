...
public class ParittaistenOtostenTTestiTehtava extends Tehtava {
    ...
    public void luoUusiTehtava() {
        ...
        String ohje1 = "Valitse annetuista vaihtoehdoista erotusten keskiarvo: ";
        String ohje2 = "Valitse annetuista vaihtoehdoista erotusten otoskeskihajonta: ";
        String ohje3 = "Valitse annetuista vaihtoehdoista testisuureen arvo: ";
    ...
    public String luoOhjeistus() {
        ...
        ohjeistus = ohjeistus + "Tutkittavat henkilöt mitattiin ennen tutkimusta ja ";
        ohjeistus = ohjeistus + x + " viikkoa intervention aloittamisen jälkeen.";
        ohjeistus = ohjeistus + System.lineSeparator();
        ohjeistus = ohjeistus + "Alla on esitetty arvot ennen intervention aloittamista ja sen jälkeen.";
        ohjeistus = ohjeistus + System.lineSeparator();
        ohjeistus = ohjeistus + System.lineSeparator();
        ohjeistus = ohjeistus + "Ennen aloittamista tutkittavien arvot olivat seuraavat:";
        ohjeistus = ohjeistus + System.lineSeparator();
