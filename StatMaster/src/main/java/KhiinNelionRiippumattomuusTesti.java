...
public class KhiinNelionRiippumattomuusTesti {
    ...
    int sarakkeet;
    int[] riviFrekvenssit;
    int[] sarakeFrekvenssit;
    int[][] havaitutFrekvenssit;
    double[][] odotetutFrekvenssit;
    double khiinNelio;
    String pArvo;
    String tulkinta;
    ...
    public void tulkinta() {
        if (this.pArvo.equals("ns")) {
            this.tulkinta = "Muuttujien välillä ei ole tilastollista yhteyttä.";
        } else {
            this.tulkinta = "Muuttujien välillä on tilastollinen yhteys.";
        }
    }
