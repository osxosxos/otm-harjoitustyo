...
public class StudentinTTestiParittaisilleOtoksilleTest {
    ...
    public void vapausAsteet1() {
        assertEquals(this.testi1.getDf(), 4);
    }
    
    @Test
    public void erotustenKeskiArvo1() {
        assertEquals(this.testi1.getErotustenKa(), 9.00, 0.01);
    }

    @Test
    public void erotustenOtosKeskiHajonta1() {
        assertEquals(this.testi1.getErotustenOtosKh(), 1.41, 0.01);
    }

    @Test
    public void tArvoTesti1() {
        assertEquals(this.testi1.getT(), 14.27, 0.01);
    }

    @Test
    public void pArvo1() {
        assertEquals(this.testi1.getpArvo(), "p <0.001");
    }
