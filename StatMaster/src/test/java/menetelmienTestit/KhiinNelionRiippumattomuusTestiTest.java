...
public class KhiinNelionRiippumattomuusTestiTest {
    ...
    @Test
    public void setN1() {
        assertEquals(khii1.getN(), 65);
    }

    @Test
    public void rivit1() {
        assertEquals(khii1.getRivit(), 3);
    }

    @Test
    public void sarakkeet1() {
        assertEquals(khii1.getSarakkeet(), 2);
    }

    @Test
    public void riviFrekvenssit1() {
        int[] odotus = new int[]{15, 25, 25};
        Assert.assertArrayEquals(odotus, khii1.getRiviFrekvenssit());
    }

    @Test
    public void sarakeFrekvenssit1() {
        int[] odotus = new int[]{20, 45};
        Assert.assertArrayEquals(odotus, khii1.getSarakeFrekvenssit());
    }
    ...
    public void odotetutFrekvenssit1() {
        ...
        for (int i = 0; i < odotus.length; i++) {
            for (int j = 0; j < odotus[0].length; j++) {
                double erotus = odotus[i][j]
                        - khii1.getOdotetutFrekvenssit()[i][j];
    ...
    public void khiinNelioArvo1() {
        assertEquals(2.41, khii1.getKhiinNelio(), 0.01);
    }

    @Test
    public void pArvo() {
        assertEquals("ns", khii1.getpArvo());
    }
